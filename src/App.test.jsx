...
describe('certification portal', () => {
  beforeEach(() => {
    ...
    global.fetch = vi.fn((url, options) => {
      ...
      if (url === '/api/projects/UPC-001') return response({ ro: 'Delhi', piu: 'Dwarka', project_name: 'NH-48 Package', upc: 'UPC-001', certification_status: 'pending', certified_at: null, mapped_rob_rub_count: 0, mappings: [] })
      if (url.endsWith('/certification') && options?.method === 'PATCH') return response({ ro: 'Delhi', piu: 'Dwarka', project_name: 'NH-48 Package', upc: 'UPC-001', certification_status: 'certified', certified_at: '2026-07-21T00:00:00Z', mapped_rob_rub_count: 0, mappings: [] })
